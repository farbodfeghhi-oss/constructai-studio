...
import { Loader2, AlertTriangle, CheckCircle, Info, ArrowRight, Wrench, RefreshCw, ArrowLeft } from "lucide-react";
...
export default function Analyse() {
  ...
  const zurueckZumDashboard = () => {
    navigate("/", {
      state: {
        description: dashboardState?.dashboardDraft?.description ?? "",
        attachments,
      },
    });
  };
